          ...
          <div class="collapse navbar-collapse" id="navbarNavDropdown">
                ...
                <div class="col-md-6">
                    <form action="search.php" method="post">
                        <div class="input-group mb-3">
                            <input required type="text" class="form-control" placeholder="Search" name="Search" aria-label="Recipient's username" aria-describedby="button-addon2" value="">
            ...
            <div id="carouselExampleFade" class="carousel slide carousel-fade mb-5" data-bs-ride="carousel">
                <div class="carousel-inner">
                    ...
                    <div class="carousel-item">
                    <img src="img/c 4.jpg" class="d-block w-100" alt="...">
                    </div>
                </div>
