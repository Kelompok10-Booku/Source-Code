...
<!-- content -->
    <div class="container">
    <h3 class = "mt-5" style=" font-family: comforter; font-weight:bolder">Detail Pesanan</h3>
        <div class="card mt-5">
        <h4 class="mb-4">Kode Pesanan : 112S30D15</h4>
            <div class="row">
                <div class="col"><img src="img/1.jpg" alt=""></div>
                <div class="col md-3">
                    <h5>Rentang Waktu</h5>
                    <div class="row"><p>Farah Ria Rahmawati</p></div>
                    <div class="row"><p>Stok : 30 buku</p></div>
                    <div class="row"><p>Status : Sedang Dikirim</p></div>
                    <div class="row"><p>Estimasi Tiba : XX-X-XXXX</p></div>
                    <div class="row">
                        <div class="col"><button class="btn btn-warning">Lihat Buku</button></div>
                        <div class="col"><button class="btn btn-primary">Pesan Lagi</button></div>
                    </div>
                </div>  
            </div>
