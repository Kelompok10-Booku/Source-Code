...
if(isset($_POST['tambah'])) {
    ...
    // $sampul = filter_input(INPUT_POST, 'sampul');
    $deskripsi = filter_input(INPUT_POST, 'deskripsi');


    $sql = "INSERT INTO buku(judul_buku, pengarang, harga, deskripsi)VALUES ('$judul_buku', '$pengarang', '$harga', '$deskripsi')";
...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="card mt-5">
            <h3 style=" font-family: bebas neue; font-weight:bolder">Tambah Buku</h3>
                <form action="" method="POST" class="">

            <div class="form-group mb-2">
                <label for="name">Judul Buku</label>
                <input class="form-control" type="text" name="judul_buku" placeholder="" required/>
            </div>

            <div class="form-group mb-2">
                <label for="no_handphone">Pengarang</label>
                <input class="form-control" type="text" name="pengarang" placeholder="" required/>
            </div>
            ...
            <div class="form-group mb-2">
                ...
                <option selected>Pilih</option>
                    <?php
                    $data = mysqli_query($koneksi,"select * from kategori order by id_kategori asc");
                    while($hasil=mysqli_fetch_assoc($data)) { ?>
                    <option value="1"><?=$hasil['nama_kategori'] ?></option>
                <?php } ?>
                </select>
            </div>
            ...
            <!-- <div class="form-group mb-4 mt-4">
                <label for="keterangan_alamat">Sampul Buku</label>
                <input type="file" name="fileToUpload" id="fileToUpload">
            </div> -->

            <div class="form-group mb-4">
                <label for="keterangan_alamat">Deskripsi</label>
                <textarea class="form-control" name="deskripsi" placeholder="Deskripsi Buku" id="floatingTextarea"></textarea>
            </div>
