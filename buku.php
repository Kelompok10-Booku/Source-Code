...
<body>
    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <h1 class="mb-4" style="font-family:bebas neue">Daftar Buku</h1>
            <a href="add_buku.php"><button style="margin-bottom:20px" data-toggle="modal" data-target="#myModal" class="btn btn-success col-md-2">Tambah</button></a>
            <table class="table table-striped" style="margin-top:20px">
                    ...
                    <tr>
                        <?php 
                            $no = 1;
                            $buku = "SELECT * FROM buku INNER JOIN kategori ON buku.id_kategori = kategori.id_kategori  ORDER BY id ASC";
                        ...
                        <td>Rp.<?= $data['harga'] ?></td>
                        <td><button class="btn btn-danger">Hapus</button>  <button class="btn btn-warning">Ubah</button></td>
                    </tr>
                    <?php } ?>
                </table>
