...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="card mt-5">
            <h3 style=" font-family: bebas neue; font-weight:bolder">Buat Voucher Diskon</h3>
            ...
            <div class="form-group mb-2">
                <label for="no_handphone">Persen</label>
                <input class="form-control" type="text" name="pengarang" placeholder="" required/>
            </div>

            <div class="form-group mb-2">
                <label for="username">Berlaku</label>
                <input class="form-control" type="text" name="penerbit" placeholder="" required/>
            </div>
            ...
            <div class="form-group mb-2">
                ...
                <select class="form-select form-select-md mb-3" aria-label=".form-select-md example">
                    ...
                    <option value="2">Ulang Tahun Booku</option>
                    <option value="3">Hari Buku Nasional</option>
                </select>
            </div>

            <div class="form-group mb-4 mt-4">
                <label for="keterangan_alamat">Gambar</label>
                <input type="file" name="fileToUpload" id="fileToUpload">
            </div>
            <input type="submit" class="btn btn-success btn-block" name="submit" value="Tambah"/>
            <input type="reset" class="btn btn-danger btn-block" name="submit" value="Batal"/>
        </form>
        </div>
