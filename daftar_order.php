...
<!-- content -->
<div class="container">
    <h1 style="font-family:bebas neue;margin-top:100px">Daftar Order</h1>
    <table class="table table-striped" style="margin-top:1opx">
        <tr class="thead-dark">
            <th>No</th>
            <th>Nama</th>
            <th>Tanggal</th>
        ...
        <tr>
            <td>1</td>
            <td>Yanti</td>
            <td>Menikmati Manisnya Racun di Bibirmu</td>
            <td>20 April 2022</td>
            <td>Rp.40.000</td>
            <td><img src="" alt=""></td>
            <td>Terkonfirmasi</td>
        ...
        <!--Footer-->
        <footer class=" text-center text-white pb-5"style="background-color:#F0E68C;margin-top:410px;">
