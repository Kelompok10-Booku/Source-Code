<?php
  ...
  // if(isset($_POST['keranjang'])){
    ...
    if(isset($_POST['addreview']))
    {
      ...
      $tambahkat = mysqli_query($koneksi,"insert into review (nama,deskripsi) values ('$nama','$deskripsi')");
      if ($tambahkat){
      echo "
      <meta http-equiv='refresh' content='1; url= detail_buku.php'/>  ";
      } else { echo "
       <meta http-equiv='refresh' content='1; url= detail_php.php'/> ";
      }
  ...
  if(isset($_POST['keranjang'])){
    $sql = "INSERT INTO keranjang() VALUES()";
  }
?>
...
<!-- content -->
    <div class="containerr">
        ...
        <div class="row">
            ...
            ?>
            <div class="col-md-3">
            <img src="img/<?= $data['gambar']; ?>" alt="" style="width: 200px; margin-top:50px;">
            </div>
            <div class="col-md-8">
                <h3><?= $data['judul']; ?></h3>
                <p><?= $data['pengarang']; ?></p>
                <h3 style="background-color:red; width:130px">Rp.<?= $data['harga']; ?></h3>
                <br><div class="border"style="border-bottom:2px solid black;margin-bottom:40px;"></div>
                <div class="row">
                    <div class="col">
                        <h4>Sinopsis/Ulasan singkat:</h4>
                        <p><?= $data['deskripsi']; ?></p>
                    </div>
                </div>
            </div>
            <div class="col-md-1">
                <div class="card">
                        <img src="img/<?= $data['gambar']; ?>" alt="" style="width:30px">
                        <div class="col">
                            <h4><?= $data['judul']; ?></h4>
                            <p><?= $data['pengarang']; ?></p>
                            <p><?= $data['harga']; ?></p>
                        ...
                        <div class="row">
                            <div class="col">
                              <form action="" method="post">
                                <input type="submit" class="btn btn-warning" name="keranjang" value="Keranjang">
                              </form>
                              </div>
                            <div class="col">
                                <a href="alamat_pengiriman.php?id=<?= $id ?>"><button class="btn btn-success">Beli</button></a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-md-6 col-md-offset-3">
            <div class="panel panel-info">
                <div class="panel-body">
                    <form action="detail_buku.php?id=<?= $data['id']; ?>" method="POST">
                        <div class="mb-3">
                            <label for="exampleFormControlInput1" class="form-label">Nama</label><br>
                            <input name="nama" type="text" class="form-control" id="exampleFormControlInput1" required></div><br>
                            <div class="mb-3">
                                <label for="exampleFormControlTextarea1" class="form-label">Deskripsi</label><br>
                                <textarea  name="deskripsi" class="form-control" id="exampleFormControlTextarea1" rows="3" placeholder="Write Your Comment Here" required></textarea>
                                <br>
                                    <button name="addreview" type="submit" class="btn btn-primary">Submit</button>
                                </form>
...
<table class="table caption-top">
    ...
    <tbody>
    <?php 
											$brgs=mysqli_query($koneksi,"SELECT * from review order by id ASC");
											$no=1;
