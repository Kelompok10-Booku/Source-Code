...
<!-- content -->
    <div class="container">
    <h3 class = "mt-5" style=" font-family: comforter; font-weight:bolder">Daftar Belanja</h3>
        <div class="card mt-5">
        <h4 class="mb-4">Pesanan</h4>
            <div class="row">
                <div class="col"><img src="img/1.jpg" alt=""></div>
                <div class="col md-3">
                    <div class="row"><p>Rp.59.000</p></div>
                    <div class="row">
                        <div class="col"><button class="btn btn-warning">Bayar</button></div>
                        <div class="col"><button class="btn btn-danger">Hapus</button></div>
                    </div>
                </div>  
            </div>
