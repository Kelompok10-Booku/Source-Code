        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarNavDropdown">
                ...
                <div class="col-md-6">
                    <form action="search.php" method="post">
                        <div class="input-group mb-3">
                            <input required type="text" class="form-control" placeholder="Search" ria-label="Recipient's username" aria-describedby="button-addon2" value="" name="Search">
            ...
            <?php
                ...
                $nk = mysqli_fetch_assoc($query);
            ?>
            <h3><?=  $nk['nama_kategori'] ?></h3>
            <div class="row justify-content-center">
                <?php 
                        ...
                        $data = mysqli_query($koneksi, "select * from buku where id_kategori = '$id' order by id asc");		
                    while($hasil = mysqli_fetch_assoc($data)) {?>

                <div class="col-md-3">
                    <div class="card" style="width: 18rem;box-shadow: rgba(0, 0, 0, 0.19) 0px 10px 20px, rgba(0, 0, 0, 0.23) 0px 6px 6px;">
